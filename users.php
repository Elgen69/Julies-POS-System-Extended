            ...
            <tbody>
                ...
                while($row = $qry->fetch_assoc()):
                    ...
                    <tr>
                        ...
                        <td class="py-0 px-1"><?php echo $row['phone_number']; ?></td>
                        <td class="text-center py-0 px-1">
                            <div class="btn-group" role="group">
                                <button id="btnGroupDrop1" type="button" class="btn btn-primary dropdown-toggle btn-sm rounded-5 py-2" data-bs-toggle="dropdown" aria-expanded="false">
                                    Action
                                </button>
